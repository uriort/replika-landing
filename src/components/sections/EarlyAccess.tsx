...
export default function EarlyAccess() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-1/3 right-1/4 w-60 h-60 bg-accent-coral/[0.05] rounded-full blur-[80px]" />
        ...
        {state === "success" ? (
          ...
          >
            ...
            <p className="text-sm text-muted">
              Thank you for your interest in Replika.
            </p>
          </motion.div>
        ) : (
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <button
              ...
              className="mt-2 w-full py-4 rounded-xl font-medium text-sm text-white transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              style={{
                background:
                  "linear-gradient(135deg, #7c5cbf 0%, #e8734a 100%)",
              }}
            >
              {state === "submitting" ? (
